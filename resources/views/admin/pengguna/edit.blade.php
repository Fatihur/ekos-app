...
<div class="row">
    <div class="col-12">
        <div class="bg-light rounded h-100 p-4">
            <h6 class="mb-4">Edit Pengguna: {{ $pengguna->nama }}</h6>
            ...
            <form action="{{ route('admin.pengguna.update', $pengguna->id) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="peran" class="form-select @error('peran') is-invalid @enderror" required>
                            ...
                            <option value="pemilik_kos" {{ old('peran', $pengguna->peran) == 'pemilik_kos' ? 'selected' : '' }}>Pemilik Kos</option>
                            <option value="pencari_kos" {{ old('peran', $pengguna->peran) == 'pencari_kos' ? 'selected' : '' }}>Pencari Kos</option>
                        </select>
                        @error('peran')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="mb-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="aktif" value="1" id="aktif" {{ old('aktif', $pengguna->aktif) ? 'checked' : '' }}>
