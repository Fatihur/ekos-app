...
// Pemilik Kos Routes
Route::middleware(['auth', App\Http\Middleware\RoleMiddleware::class.':pemilik_kos'])->prefix('pemilik')->name('pemilik.')->group(function () {
...
// Pencari Kos Routes
Route::middleware(['auth', App\Http\Middleware\RoleMiddleware::class.':pencari_kos'])->name('pencari.')->group(function () {
    // Bookmark
